  ...
  Future<void> completeConsent() async {
    ...
    if (notificationsManager.localNotificationsEnabled) {
      final ProgressStep localNotificationStep = ProgressStep(
        ...
        completionDateTime: completionTime,
        stepDescription:
            "Local notifications enabled. Necessary for background notifications on Android.",
        lastUpdatedDateTime: completionTime,
        status: Status.completed,
      );
      studyProgressService.save(progressStep: localNotificationStep);
    }
    ...
    if (notificationsManager.remoteNotificationsEnabled) {
      ...
      studyProgressService.save(progressStep: remoteNotificationStep);
    }
